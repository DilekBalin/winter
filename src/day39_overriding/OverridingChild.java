...
public class OverridingChild extends OverridingParent{
     ...
     */
         ...
         */
        OverridingParent obj2= new OverridingChild();  //constructor'i child class'tan sectik,data turunu parent class'tan sectik
        obj2.method2(); // Parent class method2
        obj2.method1(); // Child class method1   //once parent class'a gider o methodu gorse bile child 'ta overriding edilmis mi bakar evetse onu yazar
    }
