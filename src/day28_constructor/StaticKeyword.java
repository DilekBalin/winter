...
public class StaticKeyword {
    static int sayi1;
    int sayi2;
//Class icinde variable'lara deger atama zorunlulugu yoktur ve java default bir deger atar
    ...
    public static void main(String[] args) {
        ...
        StaticKeyword obj1=new StaticKeyword();  //sayi 2 'ye obje olusturarark ulastik
